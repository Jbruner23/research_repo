# colab: https://colab.research.google.com/github/justinjohn0306/VQGAN-CLIP/blob/main/VQGAN%2BCLIP(Updated).ipynb#scrollTo=VA1PHoJrRiK9
...
vqgan_imagenet_f16_16384_yaml = requests.get('https://heibox.uni-heidelberg.de/d/a7530b09fed84f80a887/files/?p=%2Fconfigs%2Fmodel.yaml&dl=1')
open('vqgan_imagenet_f16_16384.yaml', 'wb').write(vqgan_imagenet_f16_16384_yaml.content)
vqgan_imagenet_f16_16384_ckpt = requests.get('https://heibox.uni-heidelberg.de/d/a7530b09fed84f80a887/files/?p=%2Fckpts%2Flast.ckpt&dl=1')
open('vqgan_imagenet_f16_16384.ckpt', 'wb').write(vqgan_imagenet_f16_16384_ckpt.content)
...
#@markdown #**Parameters**
#@markdown ---
texts = "Above-ground, her cat Dinah had an appetite for bats, and Alice is suddenly confronted by the thought that, possibly, bats may also eat cats!" #@param {type:"string"}
